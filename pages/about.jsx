          ...
          <div className="row">
            <div className="col-lg-6">
              <ul>
                ...
                <li>
                  <i className="bi bi-rounded-right" /> <strong>Phone:</strong>{" "}
                  +123 456 7890
                </li>
                <li>
                  <i className="bi bi-rounded-right" /> <strong>City:</strong>{" "}
                  City : New York, USA
                </li>
              </ul>
            </div>
            <div className="col-lg-6">
              <ul>
                <li>
                  <i className="bi bi-rounded-right" /> <strong>Age:</strong> 30
                </li>
                <li>
